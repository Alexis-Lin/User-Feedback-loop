...
> 版本：v1（原型阶段）｜负责人：产品｜关联原型：[`交互原型 course-error-report.html`](<交互原型 course-error-report.html>)｜实现说明：[`课中报错 实现说明.md`](<课中报错 实现说明.md>)
...
完整可交互版见 [`交互原型 course-error-report.html`](<交互原型 course-error-report.html>)（支持 中/英、课中/课外 切换）。核心 4 屏：
...
各状态在 [`交互原型 course-error-report.html`](<交互原型 course-error-report.html>) 底部「状态演示」面板可切换预览。
...
- **(a) 可交互 HTML**：[`交互原型 course-error-report.html`](<交互原型 course-error-report.html>)（中英双版 + 课中/课外，可离线打开，底部含状态演示）。
